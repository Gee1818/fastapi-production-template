def get_valid_chess_data() -> str:
    return VALID_CHESS_DATA


def get_invalid_elo_data() -> str:
    return INVALID_ELO_DATA


VALID_CHESS_DATA = """[Event "Rated Blitz game"]
...
INVALID_ELO_DATA = """[Event "Rated Blitz game"]
[Site "https://lichess.org/VsUqVhC2"]
[Date "2025.07.01"]
[Round "-"]
[White "my_name_jeff"]
