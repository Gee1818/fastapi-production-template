...
class FeatureEngineer:
    ...
    def _calculate_mobility(
        ...
        white_weighted = FeatureEngineer._calculate_weighted_mobility_for_white(
            board, config
        )
        black_weighted = FeatureEngineer._calculate_weighted_mobility_for_black(
            board, config
        )
